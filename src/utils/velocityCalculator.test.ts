...
describe('VelocityCalculator', () => {
  ...
  it('calculates velocities correctly', () => {
    const sprints: Sprint[] = [
      { teamId: 1, effortCompleted: 5, milestoneTotalEffort: 140, sprintEndDate: new Date('2023-08-5') },
      { teamId: 1, effortCompleted: 8, milestoneTotalEffort: 140, sprintEndDate: new Date('2023-08-12') },
      { teamId: 1, effortCompleted: 3, milestoneTotalEffort: 140, sprintEndDate: new Date('2023-08-19') },
      { teamId: 1, effortCompleted: 12, milestoneTotalEffort: 140, sprintEndDate: new Date('2023-08-26') },
    ];
    const sampleSize = 3;
  ...
  it('handles sampleSize of 2', () => {
    const sprints: Sprint[] = [
      { teamId: 1, effortCompleted: 6, milestoneTotalEffort: 140, sprintEndDate: new Date('2023-08-5') },
      { teamId: 1, effortCompleted: 8, milestoneTotalEffort: 140, sprintEndDate: new Date('2023-08-12') },
    ];
    const sampleSize = 2;
